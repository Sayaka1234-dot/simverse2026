...
const languageFonts: Partial<Record<number, FontConfig>> = {
    [LangId.RU]: {
        family: "Playpen Sans",
        url: `${VITE_ENV?.BASE_URL ?? "/"}fonts/PlaypenSans-SemiBold.woff2`,
        weight: "normal",
    },
    [LangId.KO]: {
        family: "Cafe24 Dongdong",
        url: `${VITE_ENV?.BASE_URL ?? "/"}fonts/Cafe24Dongdong-v2.0.woff2`,
        weight: "normal",
    },
    [LangId.JA]: {
        family: "MPLUSRounded1c-Medium",
        url: `${VITE_ENV?.BASE_URL ?? "/"}fonts/MPLUSRounded1c-Medium.woff2`,
        weight: "normal",
    },
    [LangId.ZH]: {
        family: "Huninn-Regular",
        url: `${VITE_ENV?.BASE_URL ?? "/"}fonts/Huninn-Regular.woff2`,
        weight: "normal",
    },
};
