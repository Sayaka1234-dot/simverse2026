...
const VITE_DEV = Boolean(VITE_ENV?.DEV);
...
class GameSceneUpdate extends GameSceneCharacter {
    ...
    override update(delta: number): void {
        ...
        manualCommandRecorder.tick(this as unknown as GameScene, delta);

        // Evaluate text commands after all systems have run
        textCommandController.tick(this as unknown as GameScene, delta);
    }
}
