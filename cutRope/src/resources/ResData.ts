...
RES_DATA[ResourceId.IMG_DEFAULT] = new ResEntry("zeptolab.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_LOADERBAR_FULL] = new ResEntry("loaderbar_full.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_CHILLINGO] = new ResEntry("Default.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_BUTTON_DEFAULT] = new ResEntry(
    "menu_button_default.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.FNT_BIG_FONT] = new ResEntry("big_font.webp", ResourceType.FONT);
RES_DATA[ResourceId.FNT_SMALL_FONT] = new ResEntry("small_font.webp", ResourceType.FONT);
RES_DATA[ResourceId.IMG_MENU_LOADING] = new ResEntry("menu_loading.webp", ResourceType.IMAGE);
...
RES_DATA[ResourceId.IMG_MENU_BGR] = new ResEntry("menu_bgr.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_BUTTON_CRYSTAL] = new ResEntry(
    "menu_button_crystal.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_POPUP] = new ResEntry("menu_popup.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_BUTTON_CRYSTAL_ICON] = new ResEntry(
    "menu_button_crystal_icon.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_LOGO] = new ResEntry("menu_logo.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_LEVEL_SELECTION] = new ResEntry(
    "menu_level_selection.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_PACK_SELECTION] = new ResEntry(
    "menu_pack_selection.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_EXTRA_BUTTONS] = new ResEntry(
    "menu_extra_buttons.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_EXTRA_BUTTONS_EN] = new ResEntry(
    "menu_extra_buttons_en.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_MENU_BUTTON_SHORT] = new ResEntry(
    "menu_button_short.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_HUD_BUTTONS] = new ResEntry("hud_buttons.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_CANDY_01] = new ResEntry("obj_candy_01.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_SPIDER] = new ResEntry("obj_spider.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_CONFETTI_PARTICLES] = new ResEntry(
    "confetti_particles.webp",
    ResourceType.IMAGE,
    {
...
RES_DATA[ResourceId.IMG_MENU_PAUSE] = new ResEntry("menu_pause.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_RESULT] = new ResEntry("menu_result.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.FNT_FONT_NUMBERS_BIG] = new ResEntry(
    "font_numbers_big.webp",
    ResourceType.FONT
);
RES_DATA[ResourceId.IMG_HUD_BUTTONS_EN] = new ResEntry("hud_buttons_en.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_MENU_RESULT_EN] = new ResEntry("menu_result_en.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_STAR_DISAPPEAR] = new ResEntry(
    "obj_star_disappear.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_OBJ_BUBBLE_FLIGHT] = new ResEntry(
    "obj_bubble_flight.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_OBJ_BUBBLE_POP] = new ResEntry("obj_bubble_pop.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_HOOK_AUTO] = new ResEntry("obj_hook_auto.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_SPIKES_04] = new ResEntry("obj_spikes_04.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_BUBBLE_ATTACHED] = new ResEntry(
    "obj_bubble_attached.webp",
    ResourceType.IMAGE
);
...
RES_DATA[ResourceId.IMG_OBJ_SPIKES_01] = new ResEntry("obj_spikes_01.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_CHAR_ANIMATIONS] = new ResEntry("char_animations.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_CHAR_ANIMATIONS2] = new ResEntry(
    "char_animations2.webp",
    ResourceType.IMAGE
);
...
RES_DATA[ResourceId.IMG_OBJ_HOOK_MOVABLE] = new ResEntry(
    "obj_hook_movable.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_OBJ_PUMP] = new ResEntry("obj_pump.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_TUTORIAL_SIGNS] = new ResEntry("tutorial_signs.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_SOCKS] = new ResEntry("obj_hat.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_BOUNCER_01] = new ResEntry("obj_bouncer_01.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_BOUNCER_02] = new ResEntry("obj_bouncer_02.webp", ResourceType.IMAGE);
...
RES_DATA[ResourceId.IMG_DRAWING_HIDDEN] = new ResEntry(
    "obj_drawing_hidden.webp",
    ResourceType.IMAGE
);
RES_DATA[ResourceId.IMG_OBJ_BEE_HD] = new ResEntry("obj_bee_hd.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_OBJ_POLLEN_HD] = new ResEntry("obj_pollen_hd.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_CHAR_SUPPORTS] = new ResEntry("char_supports.webp", ResourceType.IMAGE, {
    atlasPath: "char_supports.json",
    atlasFormat: "texture-packer",
});
RES_DATA[ResourceId.IMG_OBJ_VINIL] = new ResEntry("obj_vinil.webp", ResourceType.IMAGE);
...
RES_DATA[ResourceId.IMG_BGR_01_P1] = new ResEntry("bgr_01_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_01_P2] = new ResEntry("bgr_01_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_02_P1] = new ResEntry("bgr_02_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_02_P2] = new ResEntry("bgr_02_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_03_P1] = new ResEntry("bgr_03_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_03_P2] = new ResEntry("bgr_03_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_04_P1] = new ResEntry("bgr_04_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_04_P2] = new ResEntry("bgr_04_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_05_P1] = new ResEntry("bgr_05_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_05_P2] = new ResEntry("bgr_05_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_06_P1] = new ResEntry("bgr_06_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_06_P2] = new ResEntry("bgr_06_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_07_P1] = new ResEntry("bgr_07_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_07_P2] = new ResEntry("bgr_07_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_08_P1] = new ResEntry("bgr_08_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_08_P2] = new ResEntry("bgr_08_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_09_P1] = new ResEntry("bgr_09_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_09_P2] = new ResEntry("bgr_09_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_10_P1] = new ResEntry("bgr_10_p1.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_10_P2] = new ResEntry("bgr_10_p2.webp", ResourceType.IMAGE);
RES_DATA[ResourceId.IMG_BGR_11_P1] = new ResEntry("bgr_11_p1.webp", ResourceType.IMAGE);
...
RES_DATA[ResourceId.IMG_TIME_STANDS] = new ResEntry("time-stands.webp", ResourceType.IMAGE);
...
RES_DATA[ResourceId.IMG_CHAR_IDLE_XMAS] = new ResEntry("char_idle_xmas.webp", ResourceType.IMAGE, {
    atlasPath: "char_idle_xmas.json",
    atlasFormat: "texture-packer",
});

RES_DATA[ResourceId.IMG_XMAS_LIGHTS] = new ResEntry("christmas_lights.webp", ResourceType.IMAGE, {
    atlasPath: "christmas_lights.json",
    atlasFormat: "texture-packer",
});

RES_DATA[ResourceId.IMG_OBJ_CANDY_PADDINGTON] = new ResEntry(
    "obj_candy_paddington.webp",
    ResourceType.IMAGE,
    {
...
RES_DATA[ResourceId.IMG_SNOWFLAKES] = new ResEntry("snowflakes.webp", ResourceType.IMAGE, {
    atlasPath: "snowflakes.json",
    atlasFormat: "texture-packer",
});

RES_DATA[ResourceId.IMG_OBJ_SOCKS_XMAS] = new ResEntry("obj_socks.webp", ResourceType.IMAGE, {
    atlasPath: "obj_socks.json",
    atlasFormat: "texture-packer",
});

RES_DATA[ResourceId.IMG_CHAR_ANIMATION_PADDINGTON] = new ResEntry(
    "char_animation_paddington.webp",
    ResourceType.IMAGE,
    {
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_05] = new ResEntry(
    "candies/obj_candy_05_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_06] = new ResEntry(
    "candies/obj_candy_06_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_07] = new ResEntry(
    "candies/obj_candy_07_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_08] = new ResEntry(
    "candies/obj_candy_08_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_09] = new ResEntry(
    "candies/obj_candy_09_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_10] = new ResEntry(
    "candies/obj_candy_10_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_11] = new ResEntry(
    "candies/obj_candy_11_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_12] = new ResEntry(
    "candies/obj_candy_12_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_13] = new ResEntry(
    "candies/obj_candy_13_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_14] = new ResEntry(
    "candies/obj_candy_14_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_15] = new ResEntry(
    "candies/obj_candy_15_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_16] = new ResEntry(
    "candies/obj_candy_16_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_17] = new ResEntry(
    "candies/obj_candy_17_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_18] = new ResEntry(
    "candies/obj_candy_18_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_19] = new ResEntry(
    "candies/obj_candy_19_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_20] = new ResEntry(
    "candies/obj_candy_20_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_21] = new ResEntry(
    "candies/obj_candy_21_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_22] = new ResEntry(
    "candies/obj_candy_22_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_23] = new ResEntry(
    "candies/obj_candy_23_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_24] = new ResEntry(
    "candies/obj_candy_24_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_25] = new ResEntry(
    "candies/obj_candy_25_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_26] = new ResEntry(
    "candies/obj_candy_26_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_27] = new ResEntry(
    "candies/obj_candy_27_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_28] = new ResEntry(
    "candies/obj_candy_28_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_29] = new ResEntry(
    "candies/obj_candy_29_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_30] = new ResEntry(
    "candies/obj_candy_30_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_31] = new ResEntry(
    "candies/obj_candy_31_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_32] = new ResEntry(
    "candies/obj_candy_32_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_33] = new ResEntry(
    "candies/obj_candy_33_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_34] = new ResEntry(
    "candies/obj_candy_34_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_35] = new ResEntry(
    "candies/obj_candy_35_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_36] = new ResEntry(
    "candies/obj_candy_36_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_37] = new ResEntry(
    "candies/obj_candy_37_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_38] = new ResEntry(
    "candies/obj_candy_38_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_39] = new ResEntry(
    "candies/obj_candy_39_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_40] = new ResEntry(
    "candies/obj_candy_40_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_41] = new ResEntry(
    "candies/obj_candy_41_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_42] = new ResEntry(
    "candies/obj_candy_42_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_43] = new ResEntry(
    "candies/obj_candy_43_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_44] = new ResEntry(
    "candies/obj_candy_44_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_45] = new ResEntry(
    "candies/obj_candy_45_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_46] = new ResEntry(
    "candies/obj_candy_46_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_47] = new ResEntry(
    "candies/obj_candy_47_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_48] = new ResEntry(
    "candies/obj_candy_48_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_49] = new ResEntry(
    "candies/obj_candy_49_extracted.webp",
    ResourceType.IMAGE,
...
RES_DATA[ResourceId.IMG_OBJ_CANDY_50] = new ResEntry(
    "candies/obj_candy_50_extracted.webp",
    ResourceType.IMAGE,
