...
export interface LevelJsonMetadata {
    levelId?: string;
    textCommandSolution?: string;
    textCommandSolutionUpdatedAt?: string;
    textCommandSolutionStars?: number;
    textCommandSolutionWon?: boolean;
}

export type LevelJson = LevelJsonCore &
    LevelJsonMetadata &
    Record<string, LevelEntity[] | LevelScalar | undefined>;
