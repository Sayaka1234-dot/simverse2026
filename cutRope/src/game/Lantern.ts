...
class Lantern extends CTRGameObject {
    ...
    constructor(x: number, y: number, selectedCandySkin: number, candyResourceId: number) {
        ...
        // The lantern can reuse candy art internally, but this is only a visual proxy.
        // The level still has one main candy physics point, not a second independent candy.
